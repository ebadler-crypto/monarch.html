...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
        ...
        .win { background: #0b1d3a; border: 1px solid #1e4a8a; border-radius: 3px; overflow: hidden; position: relative; }
        ...
        nav.nav { background: #071530; border-top: 1px solid #1a3d73; padding: 8px 10px; padding-bottom: calc(8px + env(safe-area-inset-bottom, 0px)); display: flex; justify-content: space-between; gap: 4px; flex-wrap: nowrap; }
